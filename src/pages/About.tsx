  ...
  return (
    <Layout>
      <div className="min-h-screen">
        {/* Hero Section */}
        <div className="bg-gradient-to-br from-mint to-primary/10 dark:from-gray-900 dark:to-gray-800 dark:bg-gray-900 py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h1 className="font-serif text-4xl lg:text-6xl text-primary dark:text-white mb-6">
        ...
        <div className="py-20 bg-white dark:bg-gray-900">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                <h2 className="font-serif text-3xl lg:text-4xl text-primary dark:text-white mb-6">
              ...
              <div className="relative">
                ...
                />
                <div className="absolute -bottom-6 -right-6 w-24 h-24 bg-accent dark:bg-gray-800 rounded-full flex items-center justify-center">
        ...
        {/* Values Section */}
        <div className="py-20 bg-mint/20 dark:bg-gray-800">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {values.map((value, index) => (
                <div key={index} className="bg-white dark:bg-gray-900 p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 text-center">
                  <value.icon className="h-12 w-12 text-accent dark:text-accent mx-auto mb-4" />
                  <h3 className="font-serif text-xl font-semibold text-primary dark:text-white mb-4">{value.title}</h3>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {team.map((member, index) => (
                <div key={index} className="bg-gradient-to-br from-mint/30 to-white dark:from-gray-800 dark:to-gray-900 p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 text-center">
                  <img
                    src={member.image}
                    alt={member.name}
                    className="w-32 h-32 rounded-full mx-auto mb-6 object-cover border-4 border-white dark:border-gray-800 shadow-lg"
                  />
                  <h3 className="font-serif text-xl font-semibold text-primary dark:text-white mb-2">{member.name}</h3>
