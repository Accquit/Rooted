...
const QuizSection = () => {
  ...
  return (
    <section id="quiz-section" className="py-20 bg-gradient-to-br from-mint to-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <Sparkles className="h-12 w-12 text-accent mx-auto mb-6 animate-float" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          {quizCards.map((card, index) => (
            <div key={index} className="bg-white p-6 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 animate-fade-in">
